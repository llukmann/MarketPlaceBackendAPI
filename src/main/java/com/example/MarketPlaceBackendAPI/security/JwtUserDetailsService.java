package com.example.MarketPlaceBackendAPI.security;

import com.example.MarketPlaceBackendAPI.models.User;
import com.example.MarketPlaceBackendAPI.security.jwt.JwtUser;
import com.example.MarketPlaceBackendAPI.security.jwt.JwtUserCreator;
...
public class JwtUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        JwtUser jwtUser = JwtUserCreator.create(user);
        return jwtUser;
    }
}
